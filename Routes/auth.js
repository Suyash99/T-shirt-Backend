...
router.post("/signup",
[
  check("name").isLength({ min: 3 }).withMessage('First Name must be at least 3 chars long!'),
  check("lastname").isLength({ min: 3 }).withMessage('Last Name must be at least 3 chars long!'),
